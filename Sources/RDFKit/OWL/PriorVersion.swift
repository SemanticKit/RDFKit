...
public extension OWL {
    ...
    /// owl:priorVersion.
    struct PriorVersion: RDFKit.RDFProperty, OWLLowerCamelTerm, RDFKit.AnnotationProperty, RDFKit.OntologyProperty, DomainConstrainedProperty, RangeConstrainedProperty {
