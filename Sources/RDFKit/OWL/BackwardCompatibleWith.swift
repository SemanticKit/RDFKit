...
public extension OWL {
    ...
    /// owl:backwardCompatibleWith.
    struct BackwardCompatibleWith: RDFKit.Property, OWLLowerCamelTerm, RDFKit.AnnotationProperty, RDFKit.OntologyProperty, DomainConstrainedProperty, RangeConstrainedProperty {
